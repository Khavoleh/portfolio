...
export const CONTACT_SECTION_I18N: I18N = {
  en: {
    privacy_contact_title: '6. Contact and Your Rights',
    privacy_contact_text1:
    ...
    privacy_contact_text2: 'Please contact me directly via email at:',
  },
  uk: {
    privacy_contact_title: '6. Контакти та ваші права',
    privacy_contact_text1:
    ...
    privacy_contact_text2: 'Будь ласка, зв’яжіться зі мною безпосередньо через електронну пошту:',
  },
};
