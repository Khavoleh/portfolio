...
export const PRIVACY_POLICY_TRANSLATIONS: Translations = {
  ...
  uk: {
    ...
    'privacy.collect.local.label': 'Дані локальних налаштувань:',
    'privacy.collect.local.text':
      'ми зберігаємо ваші улюблені теми сайту (наприклад, «темний» або «світлий» режим) у місцевому сховищі вашого браузера. Ці дані не є особистими і використовуються виключно для покращення вашого користувацького досвіду.',
    ...
    'privacy.cookies.local':
      '<strong>Local Storage:</strong> ми використовуємо локальне сховище вашого браузера для збереження налаштувань теми. Це функціональний механізм зберігання, що не відстежує, і дані ніколи не надсилаються на наші сервери.',
    'privacy.cookies.no_cookies':
